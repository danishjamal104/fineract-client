...
public class Group {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, office, staff, parent, groupLevel, groupMembers, clientMembers, submittedOnDate, accountNumberRequiresAutoGeneration, closed, active, pending, transferInProgress, transferOnHold, notPending, transferInProgressOrOnHold, childGroup, activeClientMembers, center, group, notActive, activationLocalDate, _new);
  }
