...
public class Client {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, office, transferToOffice, image, status, firstname, middlename, lastname, displayName, mobileNo, emailAddress, externalId, staff, groups, accountNumberRequiresAutoGeneration, closureDate, withdrawalDate, submittedOnDate, legalForm, reopenedDate, proposedTransferDate, closed, active, rejected, pending, transferInProgress, transferOnHold, notPending, transferInProgressOrOnHold, notActive, activationLocalDate, officeJoiningLocalDate, withdrawn, notStaff, rejectedDate, _new);
  }
