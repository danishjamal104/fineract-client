...
public class Money {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(currencyCode, currencyDigitsAfterDecimal, amount, zero, currency, currencyInMultiplesOf, greaterThanZero, lessThanZero, amountDefaultedToNullIfZero);
  }
