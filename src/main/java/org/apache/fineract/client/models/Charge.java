...
public class Charge {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, amount, currencyCode, chargeTimeType, chargeCalculation, chargePaymentMode, feeInterval, penalty, active, deleted, minCap, maxCap, account, taxGroup, savingsCharge, allowedSavingsChargeCalculationType, allowedClientChargeCalculationType, percentageOfDisbursementAmount, loanCharge, clientCharge, allowedLoanChargeTime, allowedClientChargeTime, allowedSavingsChargeTime, percentageOfApprovedAmount, overdueInstallment, disbursementCharge, annualFee, monthlyFee, feeOnMonthDay, _new);
  }
